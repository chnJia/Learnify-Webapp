            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="button-container">
                        <div class="row">
                            <div class="col-md-2">
                                <button type="submit" class="onsite-button" onclick="redirectToOnsiteBooking()">Onsite</button>
                            </div>
                            <div class="col-md-10">
        ...
        <div class="content container-fluid">
            <form action="post">
                <div class="form-content">
                    ...
                    <button type="submit" class="submit-button" onclick="redirectToOnlineDetail()">Proceed to Payment</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    function redirectToOnsiteBooking() {
        window.location.href = "{{ url('/booking-form-onsite') }}";
    }

    function redirectToOnlineDetail() {
        event.preventDefault();
        window.location.href = "{{ url('/booking-form-detail-online') }}";
    }
</script>